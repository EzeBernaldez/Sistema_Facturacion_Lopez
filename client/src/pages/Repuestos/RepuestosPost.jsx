...
const RepuestosPost = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try{
                ...
                if (err.response?.status === 400) {
                    formik.setFieldError('codigo', 'El código de repuesto ya existe. Por favor, use otro código');
                } else {
        ...
        validationSchema: Yup.object({
            ...
            tipo: Yup.string().max(100, 'Debe ingresar un tipo con menos de 100 caracteres.'),
    ...
    return(
        ...
        <main>
            <Box boxShadow="md" bg="#E8F1FF" p={8} width='100%' opacity='0.95'>
                <Heading as='h2' fontSize='2xl' mb={4}>Nuevo Repuesto</Heading>
                <form onSubmit={formik.handleSubmit}>
                    <VStack gap="4" alignItems='flex-start'>
                        <FormControl width='100%' isInvalid={!!formik.errors.codigo}>
