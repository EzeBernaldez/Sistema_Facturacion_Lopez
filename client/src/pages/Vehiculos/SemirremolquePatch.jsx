    ...
    useEffect(() => {
        const fetchVehiculos = async () => {
            try {
                ...
                console.error("Error actualizando semirremolque:", err);
            }
        };
        fetchVehiculos();
    }, [codigo]);
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try{
                ...
                setLoading(false);
                formik.resetForm();
                toast.success("El semirremolque se actualizó correctamente")
                navigate('/vehiculos');
            }
            catch (err){
...
export default SemirremolquePatch;